    ...
    <div className="collapse navbar-collapse" id="navbarNavDropdown">
      <ul className="navbar-nav ms-auto justify-content-center">
        ...
        <li className="nav-item dropdown me-3">
          ...
          <li><Link className="dropdown-item" href="#!">Dummy 1</Link></li>
            <li><Link className="dropdown-item" href="#!">Dummy 2</Link></li>
            <li><Link className="dropdown-item" href="#!">Dummy 3</Link></li>
          </ul>
        </li>
        <li className="nav-item dropdown me-3">
          <Link className="nav-link dropdown-toggle" href="#!" role="button" data-bs-toggle="dropdown" aria-expanded="false">
